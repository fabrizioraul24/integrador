    ...
    <div class="max-w-md w-full">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 animate-slide-up border border-gray-100 dark:border-gray-700 card-hover">
            ...
            <div class="mt-6 text-center">
                <a href="registro.php" class="text-primary hover:text-primary-dark dark:text-primary-light dark:hover:text-primary font-medium transition-colors duration-300">
